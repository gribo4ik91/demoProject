...
| `application/application/src/main/kotlin/com/example/api/service` | Business logic, orchestration, duplicate checks, and audit logging | `EcosystemService.kt`, `EcosystemLogService.kt`, `MaintenanceTaskService.kt`, `AutomationRuleService.kt`, `AuthService.kt`, `AuditLogService.kt` |
| `application/application/src/main/kotlin/com/example/api/model` | JPA domain entities | `Ecosystem.kt`, `EcosystemLog.kt`, `MaintenanceTask.kt`, `AutomationRule.kt`, `AppUser.kt`, `AuditLog.kt` |
| `application/application/src/main/kotlin/com/example/api/repository` | Data access via Spring Data JPA | `EcosystemRepository.kt`, `EcosystemLogRepository.kt`, `MaintenanceTaskRepository.kt`, `AutomationRuleRepository.kt`, `AppUserRepository.kt`, `AuditLogRepository.kt` |
| `application/application/src/main/kotlin/com/example/api/dto` | API request and response contracts plus shared validation patterns | `CreateEcosystemRequest.kt`, `LogRequest.kt`, `CreateMaintenanceTaskRequest.kt`, `CreateAutomationRuleRequest.kt`, `RegisterUserRequest.kt`, `ValidationPatterns.kt`, `AuditLogResponse.kt` |
...
| `application/application/src/main/resources/templates` | Freemarker pages and fragments | `pages/home.ftlh`, `pages/ecosystem.ftlh`, `pages/audit.ftlh`, `pages/automation-rules.ftlh`, `fragments/workspace-panel.ftlh`, `fragments/audit-list.ftlh`, `fragments/task-list.ftlh`, `fragments/log-list.ftlh`, `fragments/rule-list.ftlh` |
...
| `application/application/src/main/resources/db/migration` | Versioned database schema through Flyway | `V1__init_schema.sql` ... `V11__add_audit_logs.sql` |
...
| `project-story-docs` | Analytical and architectural documentation | `README.md`, `MODULES-OVERVIEW.md`, `01-13 *.md` |
