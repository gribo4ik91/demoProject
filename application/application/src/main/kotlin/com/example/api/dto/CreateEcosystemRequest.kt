...
/**
 * Carries the data required to create a new tracked ecosystem.
 */
@Schema(description = "Payload used to create a new tracked ecosystem.")
data class CreateEcosystemRequest(
    @field:Schema(
