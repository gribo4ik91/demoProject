...
/**
 * Configures password hashing, user lookup, and HTTP authorization rules for the application.
 */
@Configuration
class SecurityConfig {
     ...
     * Public auth pages stay reachable in secured mode, while the rest of the app requires login.
     */
    @Bean
